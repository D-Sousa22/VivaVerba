...
// Verifica se a criança tem idade para esta seção (8-10 anos)
$acessoPermitido = $criancaSelecionada && ($idadeCrianca >= 8 && $idadeCrianca <= 10);
...
<head>
  ...
  <title>VivaVerba - Atividades 8-10 anos</title>
...
<body>
  ...
  <div class="container">
    <div class="left">
      ...
      <h2>Atividades<br> recomendadas para<br> crianças de 8 a 10 anos</h2>
      <img src="Img/foguete.png" alt="Foguete" class="foguete">
      <p>Jogos e atividades focados no desenvolvimento<br> da alfabetização, coordenação motora e criatividade.</p>
    </div>
    <div class="right">
      <img src="Img/menino.jpeg" alt="Criança lendo" class="child">
    </div>
  </div>

  <section class="secao-jogos">
    <img src="Img/espaço.png" alt="Fundo jogos" class="fundo-jogos">
    <h2>Comece a Jogar</h2>

    <div class="container-geral-jogos">
      <div class="container-boxes" id="jogos-container">
        <!-- Os jogos serão carregados dinamicamente via JavaScript -->
    ...
    <div class="barra-progresso">
      ...
      <img src="Img/foguete2.png" class="pegada" id="pegada-progresso" alt="Pegada">
    </div>
  </section>
        ...
        try {
            ...
            jogos.forEach((jogo, index) => {
                ...
                if (jogo.desbloqueado) {
                    ...
                    box.innerHTML = `
                    <a href="${jogo.arquivo}" style="text-decoration: none; color: #303030; display: flex; flex-direction: column; align-items: center; justify-content: center; width: 100%; height: 100%;">
